...
void InstrumentContext::GetResumeInstructions(const void **instr, size_t *size)
{
    ...
    *instr = resume_instructions;
    *size = sizeof(resume_instructions);
}

void InstrumentContext::GetCheckInstructions(const void **instr, size_t *size)
{
    ...
    *instr = check_preempt_instrunctions;
